...
BOT_LINK         = os.getenv("BOT_LINK", "https://t.me/I_LyraMusicBot")
...
START_ANIMATION  = os.getenv("START_ANIMATION", "https://files.catbox.moe/ralhgv.mp4",)
PING_IMG_URL     = os.getenv("PING_IMG_URL", "https://files.catbox.moe/ypv6ko.jpg",)
